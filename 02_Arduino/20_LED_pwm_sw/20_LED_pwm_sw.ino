// 스위치 3개를 이용해서 LED 밝기와 모터속도를 조절하세요
// SW0 : LED, 모터의 듀티비를 25씩 증가, 인터럽트 사용 (8번)
// SW1 : LED, 모터의 듀티비를 25씩 감소, 인터럽트 사용 (9번)
// SW2 : LED, 모터를 정지, 인터럽트 사용 (10번)
